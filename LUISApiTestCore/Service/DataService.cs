...
namespace LUISApiTestCore.Service
{
	class DataService : IDataService
	{
		...
		{
			return new List<LuisIntent>() {
				new LuisIntent() { name = "DawsonTestIntent5",appId = Constants.LUISDefaultAppId, versionId = Constants.LUISVersion, IntentId = new Guid("c7c2e003-942c-429f-b1e3-d8adc008f0f8") },
